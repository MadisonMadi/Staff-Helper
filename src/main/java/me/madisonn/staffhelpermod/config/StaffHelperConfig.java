...
public class StaffHelperConfig implements ConfigData {
    ...
    public static class Messages {
        ...
        public String calibratorlocMessage = "The Calibrator can be found by going to '/spawn' and turn around, go inside then to the right you will find the Calibrator.";
        ...
        public String tackleshoplocMessage = "The Tackle Shop can be found by going to '/spawn' and turn around, go inside then to the right you will find the Tackle Shop.";
