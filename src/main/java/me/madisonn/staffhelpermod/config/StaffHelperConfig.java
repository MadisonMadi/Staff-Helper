...
public class StaffHelperConfig implements ConfigData {
    ...
    public static class Messages {
        ...
        public String eventMessage = "Make sure you check /event | Hover over the book to see how to obtain event points.";
        ...
        public String tackleshoplocMessage = "The Tackle Shop can be found by going to /spawn, turn around and then to the right you will find the Tackle Shop.";
