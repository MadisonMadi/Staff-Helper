...
public class StaffHelperConfig implements ConfigData {
    ...
    public static class Messages {
        ...
        public String baitpackMessage = "To get bait packages you can do '/vote', purchase them in '/ah' or from Fish Compendium and '/collections'.";
        ...
        public String superchargedMessage = "For a supercharge you need 1 lightning bottle and 8 shards of choice, increases base stats by each tier 1.1x, 1.25x and 1.5x and the effect lasts for x amount of catches.";
